...
<div class="container-fluid">
    ...
    <div class="card border-0 shadow rounded">
        <div class="card-body">
            <a href="{{ route('wbtbnas.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Tambah Data Baru</a>
        </div>
        <div class="card-body">
...
<tr>
    ...
    <td>
        <a href="{{ route('wbtbnas.show', $row->id) }}" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></a>
        <a href="{{ route('wbtbnas.edit', $row->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
        <form action="{{ route('wbtbnas.destroy', $row->id) }}" method="POST" style="display:inline;">
            @csrf
            @method('DELETE')
