...
@section('content')
 <div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Tambah Data WBTB Kabupaten Indramayu - Provinsi</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('wbtbprov.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="document" class="form-control" id="document" rows="3" required></textarea>
                        </div>
                        <div class="form-group">
