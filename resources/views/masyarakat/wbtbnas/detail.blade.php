...
@section('title', 'Detail WBTB Ditetapkan Secara Nasional')
                        ...
                        <div class="row">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                                    <p class="justifikasi-teks">{!! nl2br(e($wbtbnas->deskripsi)) !!}</p>
                                </div>
                                <div class="tab-pane fade" id="lokasi" role="tabpanel" aria-labelledby="lokasi-tab">
                                    <p>{{ $wbtbnas->lokasi }}</p>
                                </div>
                                <div class="tab-pane fade show active" id="document" role="tabpanel" aria-labelledby="document-tab">
                                    <p class="justifikasi-teks">{!! nl2br(e($wbtbnas->document)) !!}</p>
                                </div>
